...
::::{.banner-text}
[Bring Ethics<br>to the Classroom]{.h1}
...
:::::{.center}
[View Labs](labs-overview.html){.button}
:::::

::::
:::

:::{.banner-right .progressive-approach}
...
[A Progressive Approach]{.h1}

Integrated Ethics Labs (ie:Labs) are designed to be used as part 
of a **comprehensive, progressive plan**
that strengthens students' habits of mind and
behavior throughout a multi-year program.

:::::{.center}

[Read More...](progressive-approach.html){.button}
...
:::::{.center}
[View License Info](license.html){.button}
:::::
