...
* [web](hardware-sustainability-handout.qmd)
* [PDF](hardware-sustainability-handout.pdf)

# Overview

**Ethics background required:** 
Ideally, students should be familiar with the 4 ethical frameworks presented in
the first year curriculum (virtue ethics, deontology, consequentialism,
...
of computer systems and their impacts, including analysis of possible risks."
  ...
  - **Consequentialism:** The stakeholders would be designers, manufacturers,
...
ethics, deontology (is there a set of rules you can use?), or consequentialism.
...
Inspired by work from @Inclezan:2014.
