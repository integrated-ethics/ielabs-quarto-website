...
* [web](hospitable-code-worksheet.qmd)
* [PDF](hospitable-code-worksheet.pdf)
...
**Ethics background** desired: Virtue Ethics, Analogies, Consequentialism,
...
-   Create a way to display (PowerPoint slide or other) the 
    ...
    and possibly review the ethical frameworks.
...
-   Consequentialism: making a decision based on the consequences and 
...
-   How would you help someone come to see that inhospitable programming
    ...
    frameworks (virtue ethics, deontology, analogies, consequentialism)
    in your answer.
