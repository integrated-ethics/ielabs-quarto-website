...
* Long version of worksheet with questions and EU Guidelines
    * [web](avoiding-algorithmic-bias-worksheet.qmd) 
    * [PDF](avoiding-algorithmic-bias-worksheet.pdf) 
    
* Scenarios only version of worksheet
    * [web](avoiding-algorithmic-bias-scenarios.qmd)
    * [PDF](avoiding-algorithmic-bias-scenarios.pdf)

* EU AI Guidelines slide deck
    * [web](/slides/eu-ai-guidelines.qmd)
...
(virtue ethics, deontology,  consequentialism, analogies). If they (or the
...
(virtue ethics, deontological, analogies, consequentialism?) If they need
a refresher:
...
-   Consequentialism: making a decision based on what is best for the
    majority
...
-   Consequentialism is probably what caused the problem in the first
...
-   Assess the deontological approach to evaluating an algorithm for
    ethicality compared to the virtue ethics, analogy, or consequentialist
