...
Another common approach uses the **consequentialist framework**. There are
many varieties of this approach, but the basic idea is to consider the 
*consequences* of an action.  For example, we may consider that the right
thing to do is the thing that brings the most utility (perhaps measured as 
happiness), to the most people. 
While the action may help some and hurt others, if the
